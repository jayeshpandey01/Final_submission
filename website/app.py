...
st.set_page_config(layout="wide",page_title="SawtchEarth - Environmental Platform", page_icon="./media/favicon.ico")
...
if but.button("Calculate Your Environmental Impact!", type="primary"):
    click_element('tab-1')
